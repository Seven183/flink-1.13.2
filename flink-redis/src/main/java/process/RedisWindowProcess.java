 ...
 */
public class RedisWindowProcess extends ProcessWindowFunction<CategoryPojo, List<CategoryPojo>, String, TimeWindow> {

    @Override
    public void process(String dateTime, Context context, Iterable<CategoryPojo> elements, Collector<List<CategoryPojo>> out) throws Exception {
